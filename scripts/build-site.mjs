...
export function buildSite() {
  ...
  write('affiliate-disclosure/index.html', policyPage('제휴 마케팅 안내', '버림뚝딱의 제휴 마케팅 적용 여부와 향후 고지 원칙을 안내합니다.', '/affiliate-disclosure/', `<p>현재 버림뚝딱에는 제휴 링크, 상품 배너 또는 광고가 없습니다.</p><p>향후 제휴 기능을 사용하게 되면 사용자가 링크를 누르기 전에 경제적 이해관계를 해당 제휴 영역 가까이에 분명하게 표시하고 이 안내를 갱신합니다.</p><p>제휴 링크를 통한 구매가 적용되는 경우 구매자에게 별도 비용을 더하지 않으면서 버림뚝딱이 수수료를 받을 수 있다는 사실도 링크 전에 안내합니다.</p>`));
